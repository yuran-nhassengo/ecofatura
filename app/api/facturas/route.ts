...
export async function POST(request: Request) {
    ...
    try {
        const { codigo, nome, tipo, data, entidade, valor, descricao, nuit,produtos: Produto[] } = body;
        const newFactura = await createFactura(codigo, nome, tipo, data, entidade, valor, descricao, nuit,Produto);
